...
! E-mail: olafsdottir@climate-risk-analysis.com, kristin904@msn.com
!
! Michael Schulz, 
...
!----------------------------------------	
	...
	print '(a)',     '==============================================================================='
        print '(a)',     '                                                                               			'
        print '(a,a,a,a)', vers,'(Version 1.0',',',' December 2015)                                   		'
        print '(a)',     '                                                                               			'
        print '(a)',     '==============================================================================='
        print '(a)',     '                                                                               			'
!
...
do i= 1,ntry
	print*
	print '(a)','Please type in the name of the configuration file         [path + filename]'
	read (5,'(a)') cfgfile
...
! ----------------------------------------------------------
  if (errflagx .eqv. .true.) then
     write(*,'(/1x,a/)') "Resetting dimensions after correcting for duplicate sampling times...x"
...
! ----------------------------------------------------------
  if (errflagy .eqv. .true.) then
     write(*,'(/1x,a/)') "Resetting dimensions after correcting for duplicate sampling times...y"
...
print '(a)'
print'(A43,F5.2,A1,F10.2)',' Mean MC false alarm for coherency (alpha =',alpha,')', csig_mc
